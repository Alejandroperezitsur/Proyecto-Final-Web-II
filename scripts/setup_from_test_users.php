...
function crearGruposPorProfesor(PDO $pdo, array $materias, array $ciclos, int $porProfesor = 7, int $maxPorProfesor = 8): array {
...
function main(): void {
  ...
  try {
    ...
    $grupos = crearGruposPorProfesor($pdo, $materias, ['2024A','2024B'], 7, 8);
